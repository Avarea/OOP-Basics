...
public class Program
{
    public static void Main()
    {
        ...
        {
            ReadAndParseInput(doctors, departments, command);
        }
    ...
    private static void ReadAndParseInput(Dictionary<string, List<string>> doctors, Dictionary<string, List<List<string>>> departments, string command)
    {
